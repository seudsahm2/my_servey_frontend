...
export const translations = {
    en: {
        ...
        phoneNumberPlaceholder: 'e.g., 0911223344',
        invalidPhoneNumber: 'Please enter a valid Ethiopian phone number (starting with 09 or 07)',
        duplicatePhoneNumber: 'This phone number has already submitted a survey',
        identityVerification: 'Identity Verification',
        identityVerificationDesc: 'Please verify your phone number to continue',
        ...
        studentStep2Title: 'Your Preferences',
        studentStep2Desc: 'Help us understand your schedule',
        studentStep3Title: 'Topics & Budget',
        studentStep3Desc: 'What interests you?',
        studentStep4Title: 'Final Thoughts',
        studentStep4Desc: 'Help us create the perfect platform',
    ...
    ar: {
        ...
        phoneNumberPlaceholder: 'مثال: 0911223344',
        invalidPhoneNumber: 'يرجى إدخال رقم هاتف إثيوبي صحيح (يبدأ بـ 09 أو 07)',
        duplicatePhoneNumber: 'رقم الهاتف هذا قدم استبيانًا بالفعل',
        identityVerification: 'التحقق من الهوية',
        identityVerificationDesc: 'يرجى التحقق من رقم هاتفك للمتابعة',
        ...
        teachersInterested: 'معلمون مهتمون',
        ...
        teacherStep2Desc: 'قدرتك التدريسية',
    ...
    am: {
        ...
        required: 'ያስፈልጋል',
        optional: 'አማራጭ',
        selectAll: 'ሁሉንም ተፈጻሚ የሚሆኑትን ይምረጡ',
        phoneNumber: 'ስልክ ቁጥር',
        phoneNumberPlaceholder: 'ለምሳሌ: 0911223344',
        invalidPhoneNumber: 'እባክዎ ትክክለኛ የኢትዮጵያ ስልክ ቁጥር ያስገቡ (በ 09 ወይም 07 የሚጀምር)',
        duplicatePhoneNumber: 'ይህ ስልክ ቁጥር አስቀድሞ ዳሰሳ አስገብቷል',
        identityVerification: 'የማንነት ማረጋገጫ',
        identityVerificationDesc: 'ለመቀጠል እባክዎ ስልክ ቁጥርዎን ያረጋግጡ',
        ...
        earlyAccessInterest: 'የቀደምት መዳረሻ ፍላጎት',
